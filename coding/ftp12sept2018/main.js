...
var terms = { 
	...
	'ru': { operation:'Îïåðàöèÿ', phase:'Ôàçà', status:'Ñîñòîÿíèå', resourse:'Ðåñóðñ(û)', 
		level:'Óðîâåíü', code:'Êîä', start:'Ñòàðò', fin:'Ôèíèø', costTotal:'Ñòîèìîñòü', volSum:'Îáúåì', durSumD:'Äëèòåëüíîñòü', 
		status0:'Íå íà÷àòî', status100:'Çàâåðøåíî', statusNotFinished:'Íå çàâåðøåíî',
